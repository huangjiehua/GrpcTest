...
public class Values {
    ...
    public static Values fromRlpEncoded(byte[] data) {
    ...
    public Values get(int index) {
        if (isList()) {
            ...
            return new Values(asList().get(index));
        }
    ...
    public int countBranchNodes() {
        ...
        if (this.isList()) {
            ...
            for (Object obj : objList) {
                i += (new Values(obj)).countBranchNodes();
            }
            return i;
